...
local Window = Library.CreateLib("FloppaHub", "GrapeTheme")

local HomeTab = Window:NewTab("Home")
local InfoSection = HomeTab:NewSection("Info")
InfoSection:NewLabel("Welcome to FloppaHub - Jailbreak")
...
local FLYSPEED = 50
MainSection:NewButton("Flight", "Makes you fly, E to toggle", function()
